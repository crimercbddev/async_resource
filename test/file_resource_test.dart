...
//   when(client.get(Uri.parse(errorUrl), headers: null))
//       .thenAnswer((_) async => new http.Response('', 404));
//   when(client.get(Uri.parse(stringPath), headers: null))
//       .thenAnswer((_) async => new http.Response(stringData, 200));
//   when(client.get(Uri.parse(stringListPath), headers: null))
//       .thenAnswer((_) async => new http.Response(stringListData, 200));
//   when(client.get(Uri.parse(binaryPath), headers: null))
